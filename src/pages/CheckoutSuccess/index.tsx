...
function CheckoutSuccess() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-dvh px-4 bg-primary text-center">
      {/* Overskrift */}
 ...
 <div className="bg-white p-8 rounded-xl shadow-lg mb-5 w-full max-w-md">
        <h2 className="text-2xl md:text-3xl lg:text-4xl font-semibold text-gray-700 mb-5">Order Summary</h2>
